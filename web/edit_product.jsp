...
<html>
    <head>
        <title>Fashion Store - Edit product</title>
        <meta charset="utf-8">
                    ...
                    <div class="modal-content">
                        <form action="editproduct" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <input value=" ${detail.getImage()}" name="image" type="file" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Price</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea value="${detail.getDescription()}" name="des" type="text" class="form-control" required> </textarea>
                                </div>
                            </div>
